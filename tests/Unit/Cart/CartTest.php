...
class CartTest extends TestCase
{
    ...
    public function test_it_syncs_the_cart_to_update_quantities() //Stock view table 
    {
        $cart = new Cart(
            $user = factory(User::class)->create()
        );
    ...
    public function test_it_can_check_if_the_cart_has_changed_after_syncing() //Stock view table 
    {
        $cart = new Cart(
            $user = factory(User::class)->create()
        );
